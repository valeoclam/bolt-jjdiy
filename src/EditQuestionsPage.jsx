              ...
              <>
                ...
                {editedQuestionType === 'single' || editedQuestionType === 'multiple' ? (
                  <div>
                    ...
                    <button type="button" onClick={handleAddEditedOption} style={{ backgroundColor: '#28a745', color: 'white', border: 'none', borderRadius: '4px', padding: '5px 10px', cursor: 'pointer' }}>添加选项</button>
                  </div>
                ) : null}
                <label>
                  <input
